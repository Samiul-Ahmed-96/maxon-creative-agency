    ...
    <section id="testimonial" className="testimonial-main overflow-hidden">
      ...
      <Row className="align-items-center my-5 ">
        <Col lg={6} md={6} sm={12} xs={12}>
          <div data-aos="zoom-in" className="testmonial-img">
        ...
        <Col lg={4} md={4} sm={12} xs={12} className="p-4">
          <Slider {...settings}>
            <div className="testimonial-item">
              ...
              <h4>
                Day set fifth winged divided seas years, seas is void darkness
                winged. Season green life Don great said won't whales together
                man lesser is may Itself need moveth herb itself darkness
                likeness sixth creepeth.
              </h4>
